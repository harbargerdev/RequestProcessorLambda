...
```
    cd "RequestProcessorLambda.CallService"
    dotnet restore
```

Execute unit tests
```
    cd "RequestProcessorLambda.CallService/test/RequestProcessorLambda.CallService.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "RequestProcessorLambda.CallService/src/RequestProcessorLambda.CallService"
